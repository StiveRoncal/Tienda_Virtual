...
?>
<!-- DETALLE DEL PRODUCTO SELECIONADO -->
<br><br><br>
<hr>
<!-- breadcrumb -->
<div class="container">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
                                <?php
                                    // Validar si hay images en Detalle de un producto
                                    if(!empty($arrImages)){
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<!-- Para la Cantidad del Producto (Cantidad) +-  -->
									...
									<!-- Encriptar Id de Boto de Agregar al Carro -->
						...
						<div class="flex-w flex-m p-l-100 p-t-40 respon7">
							...
							<a href="https://twitter.com/intent/tweet?text=<?=$arrProducto['nombre']?>&url=<?= $urlShared;?>&hastags=<?=SHAREDHASH ;?>" target="_blank" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="Twitter">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								...
								<a href="#"  id="<?= openssl_encrypt($arrProductos[$p]['idproducto'],METHODENCRIPT,KEY); ?>" pr="1"
