		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<!-- Categorias Nombres RRRRRRRR -->
					<h3 class="ltext-103 cl5" ><?= $data['page_title']; ?></h3>
				...
				<div class="flex-w flex-c-m m-tb-10">
					...
					<div class="flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn3 trans-04 m-r-8 m-tb-4 js-show-filter">
						...
						<i class="icon-close-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close dis-none"></i>Categoria &nbsp;
					</div>
			...
			if(!empty($arrProductos)){
				...
				for($stive=0;$stive<count($arrProductos);$stive++){
					
					$ruta = $arrProductos[$stive]['ruta'];

					if(count($arrProductos[$stive]['images']) > 0 ){
						
						

						$portada = $arrProductos[$stive]['images'][0]['url_image'];
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= $portada; ?>" alt="<?= $arrProductos[$stive]['nombre'] ?>">

							<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$stive]['idproducto'].'/'.$ruta; ?>" 
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$stive]['idproducto'].'/'.$ruta; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								<?= $arrProductos[$stive]['nombre'] ?>
								</a>

								<span class="stext-105 cl3">
								<?= SMONEY.formatMoney($arrProductos[$stive]['precio']); ?>
								</span>
							</div>

							<div class="block2-txt-child2 flex-r p-t-3">
							<a href="#"  id="<?= openssl_encrypt($arrProductos[$stive]['idproducto'],METHODENCRIPT,KEY); ?>"
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				...
				<a href="<?= base_url()?>/tienda/categoria/<?= $data['infoCategoria']['idcategoria'].'/'.$data['infoCategoria']['ruta'].'/'.$nextPagina ?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Siguente &nbsp; <i class="fas fa-chevron-right"></i>
				</a>
