...
<body>
    ...
    <table class="tbl-hader">
        <tbody>
            <tr>
                <td class="wd33"> 
                    <!-- Recuerda usar PHP 8.1 o 7 ahora estas isando la 8.0.5 -->
                    <h1>Logo Roncal</h1>
                </td>
                ...
                <td class="text-center wd33">
                    ...
                    <p><?= DIRECCION?><br>
                    Telefono: <?= TELEEMPRESA ?><br>
                    Correo: <?= EMAIL_EMPRESA ?></p>
                </td>

                <td class="text-right wd33">    
                    <p>No. Orden <strong><?= $orden['idpedido'] ?></strong></p>
    ...
    <div class="text-center">
        ...
        <p>Si tienes preguntas sobre tu pedido, <br> ponganse en contacto con nombre, telefono y Email <br>
    Soporte Técnico: 934027842</p>
