                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="2" placeholder="Descripción Categoria" required=""></textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="photo">
                        ...
                        <label for="foto">Foto (1200 x 809)</label>
