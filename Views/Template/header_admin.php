...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="<?= media();?>/images/ns.ico">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url();?>/dashboard">Ferreteria Roncal</a>
