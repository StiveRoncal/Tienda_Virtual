<?php
    ...
    // accedes a los datos de arreglo
...
<body>
    ...
    <div class="">
        <br>
        <p class="text-center">Se Ha Generado un Orden, a Continuación encontraras los datos.</p>
        <br>
        <hr>
        <br>
        <table>
            <tr>
                <td width="33.33%">
                    <img class="logo" src="<?= media();?>/tienda/images/icons/eirl.png" alt="">
                </td>
        ...
        <table>
            ...
            <tfoot>
                ...
                <tr>
                    <th colspan="3" class="text-right">Envió:</th>
        ...
        <div class="text-center">
            <p>Si Tienes Preguntas Sobre Tu pedido, <br> Ponganse en contacto con nombre, Telefono Y Email</p>
