<?php
	...
	$tituloPreguntas = !empty(getInfoPage(PPREGUNTA)) ? getInfoPage(PPREGUNTA)['titulo'] : "";

	$infoPage = !empty(getInfoPage(PPREGUNTA)) ? getInfoPage(PPREGUNTA)['contenido'] : "";
...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?= media(); ?>/tienda/images/ns.ico"/>
<!--===============================================================================================-->
	...
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<!-- 133 x 17 -->
						<img src="<?= media(); ?>/tienda/images/icons/eirl.png" alt="Tienda Virtual">
					</a>
					...
					<div class="menu-desktop">
						...
						<!-- <li class="active-menu"> -->
							...
							<li>
								<a href="<?= base_url(); ?>/sucursales">Surcursales</a>
							</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= base_url(); ?> "><img src="<?= media(); ?>/tienda/images/icons/eirl.png" alt="Tienda Virtual"></a>
			</div>
