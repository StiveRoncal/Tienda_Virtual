			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form id="frmContacto">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="emailContacto" id="emailContacto" placeholder="Correo Electronico">
							<img class="how-pos4 pointer-none" src="<?= media();?>/tienda/images/icons/icon-email.png" alt="ICON">
						</div>

						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="mensaje" id="mensaje" placeholder="Cual es tu Pregunta o Mensaje"></textarea>
						</div>
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">
                                <a class="" href="tel:<?= TELEEMPRESA ?>"><?= TELEEMPRESA ?></a>
							</p>
						</div>
					</div>
