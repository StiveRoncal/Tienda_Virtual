        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <section id="sPedido" class="invoice">
              <div class="row mb-4">
                <div class="col-6">
                  <h2 class="page-header"><img src="<?= media();?>/tienda/images/eirl.png" alt=""></h2>
                </div>
                <div class="col-6">
              ...
              <div class="row invoice-info">
                <div class="col-4">
                  ...
                  Contacto: <?= TELEEMPRESA;?> <br>
                  Correo: <?= EMAIL_EMPRESA;?> <br>
                  Eeb: <?= WEB_EMPRESA;?>
                  </address>
                </div>
                <div class="col-4">
                  <address>Nombre Cliente: <strong><?= $cliente['nombres'].' '.$cliente['apellidos'] ?></strong><br>
