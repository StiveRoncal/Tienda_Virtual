...
<!-- Elemento para llamado de modal -->
<div id="divModal"></div>
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <?php
                ...
                $monbreCliente = $cl->name->given_name.' '.$cl->name->surname;
                $emailCliente = $cl->email_address;
                // validar si existe telefono
                ...
                //Descripcion del producto detalle


                $descripcion = $trs->description;
                $montoDetalle = $trs->amount->value;

                // Dellate de los montos de producto
                ...
                //isset => existe alguna envio o peticion
            ...
            <section id="sPedido" class="invoice">
              <div class="row mb-4">
                <div class="col-6">
                  <h2 class="page-header"><img src="<?= media(); ?>/images/img-paypal.jpg" alt=""></h2>
                </div>

                <?php 
                    if(!$reembolso){
                      // validar a acceso de cierto usuarios y si tiene permisos
                ...
                <div class="col-6 text-right">
                  ...
                  <button  class="btn btn-outline-primary" onclick="fntTransaccion('<?= $idTransaccion ?>');">
                  <i class="fa fa-reply-all" aria-hidden="true"></i> Hacer un Reembolso</button>
                </div>
                <?php
                      }
                    }
              ...
              <div class="row invoice-info">
                ...
                <div class="col-4">
                  ...
                  <strong>Nombre: </strong> <?= $monbreCliente?><br>
                ...
                <!--Movimiento de transaccion  -->
                  <table class="table table-sm">
                    ...
                    ?>
                      <tr>
                          ...
                          <td><?= $fechaReembolso.' Reembolso para '.$monbreCliente ?></td>
                  ...
                  <table class="table table-sm">
                      ...
                      <thead class="thead-light">
                        ...
                        <tr>
                          <td width="250"><strong>Comisión de Paypal</strong></td>
