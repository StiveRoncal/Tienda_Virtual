...
//llamar eventos en momento de vargar el documento
window.addEventListener('load', function(){

     //Los famosos DataTables
    ...
    if(document.querySelector("#formProductos")){
        ...
        formProductos.onsubmit = function(e){
            ...
            //Ingreso en input Codigo en Barras mayor 5
            if(intCodigo.length < 5){

                swal("Atención","El Código en Barras debe ser mayor que 5 Dígitos","error");
    ...
    if(document.querySelector(".btnAddImage")){
        ...
        btnAddImage.onclick = function(e){
            ...
            let key = Date.now();
            //Creacion de Elemento <div></div>
            let newElement = document.createElement("div");
            // agregacion de ID => <div id="div+key"></div>
...
//Validar input de codigo en barras
...
function fntInputFile(){
    ...
    inputUploadfile.forEach(function(inputUploadfile){
        ...
        //Evento de Cambio o actidad
        inputUploadfile.addEventListener('change', function(){
            //input tipo hidden de ID de Formulario producto
...
function fntDelItem(element){
    //fntDelItem('#div1234568' => element+ boton su clase) .imgname=>valor de atributo
    ...
    request.onreadystatechange = function(){
        ...
        if(request.status == 200){
            ...
            if(objData.status){
                ...
                //eliminacion de elemeto 
                itemRemove.parentNode.removeChild(itemRemove);
                swal("ELiminado Correctamente", objData.msg,"success");
    ...
    request.onreadystatechange = function(){
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status){
                ...
                //crear para que exista un html
                let htmlImage = "";
                //validad estado de producto en formato HTML para verlo
                ...
                //Validad cantidad de img de productos
    ...
    request.onreadystatechange = function(){
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status){
                ...
                //renderizadcion de combox de list
                $('#listCategoria').selectpicker('render');
                $('#listStatus').selectpicker('render');
                // vista del codigo en barras
                fntBarcode();

                //Mostrar imganes de productos
                //Condicional si encontra alguna img
                if(objProducto.images.length > 0){
...
//Generacion de img de codigo en barra
function fntBarcode(){
...
function openModal(){
    ...
    //Ocultar Imagenes y Codigo en Barras
    document.querySelector("#divBarCode").classList.add("notBlock");
